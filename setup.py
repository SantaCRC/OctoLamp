...
plugin_identifier = "octolamp"

# The plugin's python package, should be "octoprint_<plugin identifier>", has to be unique
plugin_package = "octoprint_OctoLamp"

# The plugin's human readable name. Can be overwritten within OctoPrint's internal data via __plugin_name__ in the
# plugin module
plugin_name = "OctoPrint-Octolamp"
...
plugin_author = "Fabian Alvarez"

# The plugin's author's mail address.
plugin_author_email = "hi@fabianalvarez.dev"

# The plugin's homepage URL. Can be overwritten within OctoPrint's internal data via __plugin_url__ in the plugin module
plugin_url = "https://github.com/SantaCRC/OctoPrint-Octolamp"
